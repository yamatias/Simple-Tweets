...
<img src='http://imgur.com/TeBDZDp.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

If the link does not work, see here http://imgur.com/TeBDZDp

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

The challenge was in giving the app the look and feel of the Twitter app itself. Since Twitter has so many features and
I only had a week to work on them, I focused on the most important aspects of the application. Getting the styling to be
similar to that of Twitter also took some more work, but I think in the end it turned out to be worth it.
